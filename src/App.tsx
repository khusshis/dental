...
import { 
  ...
  Sparkles, Baby, Heart, Star, ArrowUp, Clock, MessageCircle
} from 'lucide-react';
      ...
      >
        <div className="w-full">
          ...
          >
            ...
            {/* Mobile Menu Toggle */}
            <button className="lg:hidden p-2 text-[#1e3a8a] hover:text-[#3b82f6] transition-colors z-10 pointer-events-auto" onClick={() => setIsMenuOpen(!isMenuOpen)}>
          ...
          <div className="md:w-1/2 z-10 pr-4 lg:pr-12">
            ...
            <div className="flex items-center gap-3 md:gap-5 mb-10">
              <motion.a 
                ...
                whileTap={{ scale: 0.97 }}
                className="relative overflow-hidden bg-gradient-to-r from-[#3b82f6]/15 to-[#60a5fa]/15 backdrop-blur-md border border-[#3b82f6]/30 text-[#1e3a8a] px-6 py-3 md:px-9 md:py-4 font-bold rounded-full transition-all duration-300 shadow-[0_8px_32px_rgba(59,130,246,0.15)] flex items-center gap-2 md:gap-3 group"
              >
                ...
                <span className="relative flex items-center justify-center w-7 h-7 md:w-9 md:h-9 rounded-full bg-[#3b82f6]/15 group-hover:bg-[#3b82f6] transition-colors duration-300">
                  <Phone size={16} className="text-[#3b82f6] group-hover:text-white transition-colors duration-300" />
                </span>
                <span className="relative text-[13px] md:text-[15px]">Call Us</span>
              </motion.a>
              <motion.a 
                ...
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.97 }}
                className="relative overflow-hidden bg-white/60 backdrop-blur-md border border-[#25D366]/30 text-[#1e3a8a] px-6 py-3 md:px-9 md:py-4 font-bold rounded-full transition-all duration-300 shadow-[0_8px_32px_rgba(37,211,102,0.1)] flex items-center gap-2 md:gap-3 group"
              >
                ...
                <span className="relative flex items-center justify-center w-7 h-7 md:w-9 md:h-9 rounded-full bg-[#25D366]/15 group-hover:bg-[#25D366] transition-colors duration-300">
                ...
                <span className="relative text-[13px] md:text-[15px]">WhatsApp Us</span>
              </motion.a>
            </div>
